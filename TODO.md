...
Новая бизнес-логика размещается в `src/ispano`; корневые переходные launchers удалены. Реальные выгрузки хранятся только в `exports/` и не используются как fixtures.

...
каждого тикета в ИИ и записывает краткий содержательный результат (не более 600
...
## Текущие выясненные ограничения

Ожидаемо, но для суммаризации модели на 1.7b не хватает, необходимо хотя бы 8 и повторное тестирование. При использовании claude sonnet 4.6 проблем с суммаризацией не возникает, но необходимо найти локальное решение. 